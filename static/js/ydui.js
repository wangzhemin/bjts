! function(t) {
    ...
    function o(t) { return { set: function(e, i) { t.setItem(e, n.serialize(i)) }, get: function(e) { return n.deserialize(t.getItem(e)) }, remove: function(e) { t.removeItem(e) }, clear: function() { t.clear() } } }
    var e = t.document,
        i = {};
    $(t).on("load", function() { "function" == typeof FastClick && FastClick.attach(e.body) });
    var n = i.util = {
        parseOptions: function(t) {
            if ($.isPlainObject(t)) return t;
            var e = t ? t.indexOf("{") : -1,
                i = {};
            if (-1 != e) try { i = new Function("", "var json = " + t.substr(e) + "; return JSON.parse(JSON.stringify(json));")() } catch (t) {}
            return i
        },
        pageScroll: function() {
            var t = function(t) { t.preventDefault(), t.stopPropagation() },
                i = !1;
            return { lock: function() { i || (i = !0, e.addEventListener("touchmove", t)) }, unlock: function() { i = !1, e.removeEventListener("touchmove", t) } }
        }(),
        localStorage: function() { return o(t.localStorage) }(),
        sessionStorage: function() { return o(t.sessionStorage) }(),
...
function(t) { t.document.addEventListener("touchstart", function(t) {}, !1) }(window),
function(t) {
    "use strict";

    function i(t, e) { this.$element = $(t), this.options = $.extend({}, i.DEFAULTS, e || {}), this.init() }

    function n(t) { return this.each(function() { new i(this, t) }) }
    var e = t.YDUI.util;
    i.DEFAULTS = { binder: t, initLoad: !0, pageSize: 0, loadingHtml: "加载中...", doneTxt: "没有更多数据了", backposition: !1, jumpLink: "", loadListFn: null, loadStorageListFn: null }, i.prototype.init = function() {
        var i = this,
            n = i.options,
            o = t.location;
        ...
        o && n.stop().animate({ scrollTop: o.offsetTop }, 0, function() { t.scrolling = !1 }), i.backposition && t.bindLinkEvent(), e.pageScroll.unlock(), e.sessionStorage.remove(t.backParamsKey)
        ...
        $(t.options.binder).on("click.ydui.infinitescroll", t.options.jumpLink, function(i) {
            ...
            e.sessionStorage.set(t.backParamsKey, { offsetTop: $(t.options.binder).scrollTop() + n.offset().top - t.listOffsetTop, page: o }), location.href = n.attr("href")
        })
        ...
        if (i) {
            ...
            for (var n = i.page, o = [], a = 1; a <= n; a++) {
                ...
                o.push({ page: a, list: r }), a == n && r.length < t.options.pageSize && (t.$element.append('<div class="list-donetip">' + t.options.doneTxt + "</div>"), t.$loading.hide(), t.loading = !1, t.isDone = !0)
            }
            t.options.loadStorageListFn(o, n + 1).done(function() { t.scrollPosition() })
        }
    }, $.fn.infiniteScroll = n
}(window),
function(t) {
    ...
    e.DEFAULTS = { loadListFn: null, initLoad: !0, distance: 100 }, e.prototype.init = function() {
        ...
        var t = this;
        t.touches.loading = !0, "function" == typeof t.options.loadListFn && t.options.loadListFn().done(function() { setTimeout(function() { t.$dragTip.css({ transform: "translate3d(0px, " + t.options.distance / 1.5 + "px, 0px) scale(0)" }), t.resetDragTip() }, 200) })
...
function(t) {
    ...
    function o(t, e) { this.$element = $(t), this.options = $.extend({}, o.DEFAULTS, e || {}), this.init() }
    ...
    o.DEFAULTS = { disorder: !1, title: "安全键盘" }, o.prototype.init = function() {
            function e() { for (var t = "", e = 0; e < 6; e++) t += "<li><i></i></li>"; return t }
            var t = this;
        ...
        }, o.prototype.clearError = function() { this.$element.find(".keyboard-error").html("") }, o.prototype.error = function(t) {
            var e = this;
        ...
        }, o.prototype.upsetOrder = function(t) { for (var o, a, r, e = Math.floor, i = Math.random, n = t.length, s = e(n / 2) + 1; s--;) o = e(i() * n), a = e(i() * n), o !== a && (r = t[o], t[o] = t[a], t[a] = r); return t },
        $.fn.keyBoard = a
}(window),
function(t) {
    "use strict";
    ...
    e.DEFAULTS = { input: ".J_Input", add: ".J_Add", minus: ".J_Del", unit: 1, max: 0, min: -1, longpress: !0, callback: null }, e.prototype.init = function() {
        ...
        if (!r.attr("readonly") && !r.attr("disabled")) {
            var c;
            if ("add" == t) { if (c = s + o, 0 != n && c > n) return } else if ((c = s - o) < a) return;
...
function(t, e) {
    ...
    i.confirm = function(t, i, o) {
        ...
        2 == r && (o = i, i = t, t = "提示");
        var s = o;
        "function" == typeof o && (s = [{ txt: "取消", color: !1 }, { txt: "确定", color: !0, callback: function() { o && o() } }]);
        ...
        $.each(s, function(t, i) {
            ...
            "boolean" == typeof i.color ? n = $('<a href="javascript:;" class="confirm-btn ' + (i.color ? "primary" : "default") + '">' + (i.txt || "") + "</a>") : "string" == typeof i.color && (n = $('<a href="javascript:;" style="color: ' + i.color + '">' + (i.txt || "") + "</a>")),
                function(t) { n.on("click", function(i) { i.stopPropagation(), s[t].stay || (e.util.pageScroll.unlock(), c.remove()), s[t].callback && s[t].callback() }) }(t), l.append(n)
        ...
        e.util.pageScroll.lock(), n.append(a), a.find("a").on("click", function() { a.remove(), e.util.pageScroll.unlock(), "function" == typeof i && i() })
    }, i.toast = function() {
        var t = null;
        return function(i, o, a, r) {
            ...
            e.util.pageScroll.lock(), n.append(u), "function" == typeof a && arguments.length >= 3 && (r = a, a = 2e3), t = setTimeout(function() { clearTimeout(t), e.util.pageScroll.unlock(), u.remove(), "function" == typeof r && r() }, (~~a || 2e3) + 100)
        }
    }(), i.notify = function() {
        var t = null;
        return function(e, i, o) {
            ...
            n.append(r);
            var s = function() { r.remove(), "function" == typeof o && o() },
                c = function() { clearTimeout(t), r.find(".m-notify").addClass("notify-out"), r.one("webkitTransitionEnd", s).emulateTransitionEnd(150) };
...
function(t) {
    ...
    function n(t, e) { this.pathTemplate = "M 50,50 m 0,-{radius} a {radius},{radius} 0 1 1 0,{2radius} a {radius},{radius} 0 1 1 0,-{2radius}", a.apply(this, arguments) }

    function o(t, e) { this.pathTemplate = "M 0,{center} L 100,{center}", a.apply(this, arguments) }

    function a(t, e) { this.$element = $(t), this.options = $.extend({}, a.DEFAULTS, e || {}) }
    ...
    n.prototype = new a, n.prototype.getPathString = function(t) {
    ...
    }, n.prototype.initSvg = function(t) { t.setAttribute("viewBox", "0 0 100 100"), t.style.display = "block", t.style.width = "100%" }, o.prototype = new a, o.prototype.getPathString = function(t) { var e = this; return e.render(e.pathTemplate, { center: t / 2 }) }, o.prototype.initSvg = function(t, e) { t.setAttribute("viewBox", "0 0 100 " + e.strokeWidth), t.setAttribute("preserveAspectRatio", "none"), t.style.width = "100%", t.style.height = "100%" }, a.DEFAULTS = { type: "circle", strokeWidth: 0, strokeColor: "#E5E5E5", trailWidth: 0, trailColor: "#646464", fill: "", progress: 0, delay: !0, binder: t }, a.prototype.set = function(t) {
        var e = this,
        ...
        n.appendChild(o);
        var a = null;
        return (i.trailColor || i.trailWidth) && (a = t.createTrailPath(i), a.style.strokeDashoffset = a.getTotalLength(), n.appendChild(a)), t.svg = n, t.trailPath = a, { svg: n, trailPath: a }
    ...
    }, a.prototype.createPathElement = function(t, i, n, o) { var a = e.createElementNS("http://www.w3.org/2000/svg", "path"); return a.setAttribute("d", t), a.setAttribute("stroke", i), a.setAttribute("stroke-width", n), o ? a.setAttribute("fill", o) : a.setAttribute("fill-opacity", "0"), a }, a.prototype.render = function(t, e) {
        var i = t;
        for (var n in e)
...
function(t) {
    ...
    function a(t, e) { this.$element = $(t), this.closeElement = e, this.toggleClass = "actionsheet-toggle" }
    ...
    a.prototype.open = function() {
        ...
        var t = this;
        n.append(o), o.on("click.ydui.actionsheet.mask", function() { t.close() }), t.closeElement && i.on("click.ydui.actionsheet", t.closeElement, function() { t.close() }), t.$element.addClass(t.toggleClass).trigger("open.ydui.actionsheet")
...
function(window) {
    ...
    util.timestampTotime = function(t, e) {
        ...
        var ra = 1,
            rb = 1,
            m;
        try { ra = arg1.toString().split(".")[1].length } catch (t) {}
        try { rb = arg2.toString().split(".")[1].length } catch (t) {}
        ...
        try { var result = eval("((" + arg1 + ")" + op + "(" + arg2 + "))/" + m) } catch (t) {}
        return result
...
function(t) {
    ...
    e.TRANSITION_DURATION = 150, e.DEFAULTS = { nav: ".tab-nav-item", panel: ".tab-panel-item", activeClass: "tab-active" }, e.prototype.init = function() {
        ...
        function s() { "function" == typeof n && n() }
        var o = this,
...
function() {
    ...
    function t(e, n) {
        ...
        if (n = n || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = n.touchBoundary || 10, this.layer = e, this.tapDelay = n.tapDelay || 200, this.tapTimeout = n.tapTimeout || 700, !t.notNeeded(e)) {
            ...
            i && (e.addEventListener("mouseover", this.onMouse, !0), e.addEventListener("mousedown", this.onMouse, !0), e.addEventListener("mouseup", this.onMouse, !0)), e.addEventListener("click", this.onClick, !0), e.addEventListener("touchstart", this.onTouchStart, !1), e.addEventListener("touchmove", this.onTouchMove, !1), e.addEventListener("touchend", this.onTouchEnd, !1), e.addEventListener("touchcancel", this.onTouchCancel, !1), Event.prototype.stopImmediatePropagation || (e.removeEventListener = function(t, i, n) { var o = Node.prototype.removeEventListener; "click" === t ? o.call(e, t, i.hijacked || i, n) : o.call(e, t, i, n) }, e.addEventListener = function(t, i, n) { var o = Node.prototype.addEventListener; "click" === t ? o.call(e, t, i.hijacked || (i.hijacked = function(t) { t.propagationStopped || i(t) }), n) : o.call(e, t, i, n) }), "function" == typeof e.onclick && (o = e.onclick, e.addEventListener("click", function(t) { o(t) }, !1), e.onclick = null)
        }
    }
